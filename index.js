function getTextToInject() {
    ...
    paragraph2 = `${contentObject}${contentAction}，其实就是${contentObject}${contentAction}了。那么${contentObject}为什么会${contentAction}呢，相信大家都很好奇是怎么回事。大家可能会感到很惊讶，${contentObject}怎么会${contentAction}呢？`
